...
df = pd.read_csv(
    "/home/marian/DP/removed-front-teeth/splits/removed-front-teeth-split.csv"
)
...
df_all.to_csv("/home/marian/DP/removed-front-teeth/splits/unary-split.csv", index=False)
